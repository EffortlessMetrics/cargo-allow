...
- Follow the two distinct workspace skills in `.agents/skills/`:
  - `review-current-head`: Independent exact base/head PR review and merge-readiness verification.
  - `cargo-allow-0.2-campaign`: Execution and orchestration for active campaign issues (#3770).
