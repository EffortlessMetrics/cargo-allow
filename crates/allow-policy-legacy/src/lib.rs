use allow_core::{AllowConfig, CargoAllowError, CargoAllowResult, Finding, SimpleDate};
...
mod tests {
    use super::*;
    use allow_core::{
        FindingKind, Lifecycle, Span, StructuralIdentity, normalize_snippet, stable_hash_hex,
    };
    use std::fs;
