...
pub(super) fn config_with(entry: AllowEntry) -> AllowConfig {
...
pub(super) fn dependency_surface_entry(path: &str) -> AllowEntry {
    AllowEntry {
...
pub(super) fn generated_code_entry(path: &str) -> AllowEntry {
    AllowEntry {
...
pub(super) fn executable_entry(path: &str) -> AllowEntry {
    AllowEntry {
...
pub(super) fn config_policy_entry(
    id: &str,
    family: &str,
    path: &str,
    symbol: &str,
...
pub(super) fn finding(path: &str, line: u32, container: &str) -> Finding {
...
pub(super) fn git(root: &PathBuf, args: &[&str]) {
