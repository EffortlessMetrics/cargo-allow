...
pub use diff::{
    ...
    render_diff_posture_summary_human_with_evidence_health, render_diff_pr_summary_markdown,
...
pub use receipt::{
    render_receipt, render_receipt_with_context, render_receipt_with_context_and_inventory,
};
