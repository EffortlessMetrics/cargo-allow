...
pub use artifacts::{
    ...
    CANDIDATE_PREPARATION_PLAN_SCHEMA_V1, CANDIDATE_PREPARATION_RESULT_SCHEMA_V1,
    CandidateApplyLockRecordV1, CandidateApplyOperationRecordV1, CandidateApplyReceiptV1,
    CandidateApplyStateV1, CandidateCollisionResultV1, CandidateContentStateV1,
    CandidateCorpusRoleV1, CandidateCorpusSourceV1, CandidateExternalObservationV1,
    CandidateFileOperationV1, CandidateGovernedFileClassV1, CandidateOperationCompilerInput,
    CandidateOperationPlanV1, CandidateOperationPostureV1, CandidatePackageRowV1,
    ...
    CandidateSupportChannelPostureV1, CandidateSurfaceDecisionV1, CandidateSurfaceInputV1,
    CandidateValidationObligationV1, CargoAllowGitHubPrAnnotationV1,
    CargoAllowGitHubPrCheckReceiptV1, CargoAllowGitHubPrCheckV1, ChannelPostureV1,
