use crate::artifact_schema_expectations::{
    evidence_change_fields, exception_identity_change_fields, expected_top_level_required_fields,
    expected_top_level_schema_properties, finding_posture_kinds, lifecycle_change_fields,
