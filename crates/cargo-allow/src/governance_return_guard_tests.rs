...
const FROZEN_FILES: &[&str] = &[
    ...
    "crates/allow-policy/src/product_crates/closure.rs",
    "crates/allow-policy/src/product_crates/closure_tests.rs",
    "crates/allow-policy/src/product_crates/config.rs",
    "crates/allow-policy/src/product_crates/cross_check.rs",
    "crates/allow-policy/src/product_crates/dependency_graph.rs",
    "crates/allow-policy/src/product_crates/mod.rs",
    "crates/allow-policy/src/product_crates/receipt.rs",
    "crates/allow-policy/src/product_crates/tests.rs",
    "crates/allow-policy/src/product_crates/v1_reader.rs",
    "crates/allow-policy/src/product_crates/v2.rs",
    "crates/allow-policy/src/product_crates/v2_reconcile.rs",
    "crates/allow-policy/src/product_crates/v2_reconcile_tests.rs",
    "crates/allow-policy/src/product_crates/v2_tests.rs",
    "crates/allow-policy/src/product_crates/v2_validate.rs",
    "crates/allow-policy/src/product_crates/validate.rs",
    "crates/allow-policy/src/product_crates/workspace.rs",
...
const FROZEN_SYMBOLS: &[&str] = &[
    ...
    "HistoricalReaderDiagnostic",
    "HistoricalV1Projection",
    "IdentityDiagnostic",
    ...
    "corpus_digest",
    "current_architecture_receipt_at",
    ...
    "is_clean",
    "knows",
    "load_workspace_dependency_graph",
    ...
    "read_v1_as_historical",
    "reconcile_v2_denominators",
    ...
    "validate_architecture_denominators",
    "validate_architecture_denominators_at",
    "validate_architecture_manifest",
    "validate_architecture_manifest_at",
    "validate_architecture_with_dependency_graph",
    "validate_architecture_with_dependency_graph_at",
