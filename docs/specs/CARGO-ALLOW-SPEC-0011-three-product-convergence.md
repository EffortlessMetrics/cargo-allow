...
The first release-blocking implementation packets are fixed as:

```text
A   Issue #2882 and PR #2920
B1  Issue #2921 — strict identities and V1 historical reader
B2  Issue #2922 — bounded Cargo metadata and selected closures
B3  Issue #2923 — current V2 authority and no-new enforcement
C   Issue #2885 — atomic package identity and version migration
H1  Issue #2924 — selected package bytes and packaged-manifest proof
H2  Issue #2925 — isolated local-registry install and resolved graph
H3  Issue #2926 — supported journey and exact candidate receipt
```

The middle convergence owners remain the product-boundary issues named in the
implementation plan: #2583, #2602, #2587, and #2584 for dependency neutrality;
#2586 for the canonical intent engine; #2601 for operation cutover; and #2568
for embedded-authority deletion.
