...
PR-local implementation-slice rule for cargo-allow's design-to-proof system. It
keeps specification acceptance, runtime implementation, execution evidence, and
...
- treat a merged specification as runtime implementation;
...
independent implementation-slice file. Existing spec-system profiles remain
compatible because this source does not add a required configuration root or
change the default profile behavior.
