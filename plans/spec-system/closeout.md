...
- Active-goal TOML validation now parses `.codex/goals/active.toml`, checks
  ...
  ready/in-progress/done work items, requires closeouts for done work items,
  and routes those lifecycle findings as advisory repair work.
