...
| Preview release readiness review | passed locally | `docs/release/0.1.7.md` records version/tag/release state, main CI evidence through run `27431830114`, spec-system blocking-mode checks, and the default no-new guard. No package, tag, publish, install-smoke, or stable-support claim is included. |
