...
| import/parity [#1466](https://github.com/EffortlessMetrics/cargo-allow/issues/1466) | **Execution lane queued.** Umbrella open; first slice [#1713](https://github.com/EffortlessMetrics/cargo-allow/issues/1713) (semantic selector fields) ready in active.toml; siblings [#1714](https://github.com/EffortlessMetrics/cargo-allow/issues/1714)–[#1718](https://github.com/EffortlessMetrics/cargo-allow/issues/1718) sequenced; no full import mode yet | gap | repo-infra | import-parity-pr-001; #1466 split index; CARGO-ALLOW-PROP-0004; CARGO-ALLOW-SPEC-0004 | import-parity-1713 ready |
