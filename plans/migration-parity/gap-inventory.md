...
and the [PR queue](pr-queue.md). Last reconciled for federation F2 PR #1758
...
| P2 multi-ledger federation F2 (#1473) | Multi-ledger check evaluation and receipt `ledger_contributors` provenance; divergence receipts and drain enforcement remain F3 | in PR | repo-infra | `portable-governance-f2-federation`; CARGO-ALLOW-PLAN-0007 F2 slice; #1758 | #1758 |
