...
| P2 multi-ledger federation (#1473) | Design ready; federation across additional legacy ledgers needs proposal/spec acceptance before implementation | ready (design-first) | repo-infra | `portable-governance-f0-federation`; CARGO-ALLOW-PROP-0002 / CARGO-ALLOW-SPEC-0002; docs/source-of-truth/README.md Level 1 | f0 |
