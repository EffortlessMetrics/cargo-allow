...
#1718 ripr-style adoption dogfood receipt (2026-06-18).
...
| import/parity [#1466](https://github.com/EffortlessMetrics/cargo-allow/issues/1466) | **Execution lane slices landed.** Umbrella open; [#1713](https://github.com/EffortlessMetrics/cargo-allow/issues/1713)–[#1718](https://github.com/EffortlessMetrics/cargo-allow/issues/1718) characterization slices landed; [#1718](https://github.com/EffortlessMetrics/cargo-allow/issues/1718) ripr-style in-repo dogfood receipt records multi-family compat→migrate→check→worklist→closeout without external `ripr` migration; no full import mode yet | gap | repo-infra | `docs/dogfood/cargo-allow-ripr-style-adoption.md`; `import_parity_metadata_acceptance_tests.rs`; `legacy_import_batch.rs`; #1466 split index; CARGO-ALLOW-PROP-0004; CARGO-ALLOW-SPEC-0004 | import-parity-1718 done |
