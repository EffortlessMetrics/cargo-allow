...
| --- | --- | --- | --- | --- | --- |
| non-rust | Fixture matrix + side-by-side dogfood receipt prove compat/migrate/canonical/worklist/closeout; all criteria met | complete | repo-infra | `migration_fixture_matrix_tests.rs`; `tests/fixtures/migration/`; `docs/dogfood/cargo-allow-compat-lane-receipts.md` | adoption |
| generated | Fixture matrix + edge-case drift fixture (`generated-drift.toml`) cover covered_by preservation, generator drift, and missing-regenerate-command cases; all criteria met | complete | repo-infra | `tests/fixtures/migration/generated.toml`; `tests/fixtures/migration/generated-drift.toml`; `docs/dogfood/cargo-allow-compat-lane-receipts.md` | adoption |
| executable | Fixture matrix + edge-case drift fixture (`executable-drift.toml`) cover covered_by preservation, tree-mode drift, and missing-interpreter cases; all criteria met | complete | repo-infra | `tests/fixtures/migration/executable.toml`; `tests/fixtures/migration/executable-drift.toml`; `docs/dogfood/cargo-allow-compat-lane-receipts.md` | adoption |
| workflow | Fixture matrix + edge-case fixture (`workflow-edge-cases.toml`) cover reusable workflows, no-external-actions, and multi-secret cases; all criteria met | complete | repo-infra | `tests/fixtures/migration/workflow.toml`; `tests/fixtures/migration/workflow-edge-cases.toml`; `docs/dogfood/cargo-allow-compat-lane-receipts.md` | adoption |
| dependency-surface | Fixture matrix + side-by-side dogfood receipt prove compat/migrate/canonical/worklist/closeout; all criteria met | complete | repo-infra | `tests/fixtures/migration/dependency-surface.toml`; `docs/dogfood/cargo-allow-compat-lane-receipts.md` | adoption |
| process | Fixture matrix + side-by-side dogfood receipt prove compat/migrate/canonical/worklist/closeout; all criteria met | complete | repo-infra | `tests/fixtures/migration/process.toml`; `docs/dogfood/cargo-allow-compat-lane-receipts.md` | adoption |
| network | Fixture matrix + side-by-side dogfood receipt prove compat/migrate/canonical/worklist/closeout; all criteria met | complete | repo-infra | `tests/fixtures/migration/network.toml`; `docs/dogfood/cargo-allow-compat-lane-receipts.md` | adoption |
| no-panic allowlist | Fixture matrix + side-by-side dogfood receipt prove compat/migrate/canonical/worklist/closeout; all criteria met | complete | repo-infra | `tests/fixtures/migration/no-panic-allowlist.toml`; `docs/dogfood/cargo-allow-compat-lane-receipts.md` | adoption |
| panic baseline | B5 dogfood receipt + missing-evidence variant (`panic-baseline-no-evidence.toml`) prove compat/migrate/canonical/worklist/closeout for full lane; all criteria met | complete | repo-infra | `docs/dogfood/cargo-allow-panic-baseline.md`; `tests/fixtures/migration/panic-baseline*.toml`; #1691 | adoption |
| lint-exception | Fixture matrix + side-by-side dogfood receipt prove compat/migrate/canonical/worklist/closeout; all criteria met | complete | repo-infra | `tests/fixtures/migration/lint-exception*.toml`; `docs/dogfood/cargo-allow-compat-lane-receipts.md` | adoption |
| unsafe | B5 dogfood receipt + missing-evidence variant (`unsafe-no-evidence.toml`) prove compat/migrate/canonical/worklist/closeout for full lane; all criteria met | complete | repo-infra | `docs/dogfood/cargo-allow-unsafe-allowlist.md`; `tests/fixtures/migration/unsafe*.toml` | adoption |
