...
through `adoption-substrate-pr-014`) on the path to migration and evidence
...
fingerprints (#1726, merge `4f19e298`), D5 lint attribute target
identity (#1728, merge `7b2f2785`), D6 matcher selector precision (#1730, merge
`10e98453`), and D7 diff posture identity characterization (#1732, merge
`1f67fd64`).
...
### Structural identity D7 (adoption-substrate-pr-014)

- `allow-diff` `structural_identity_posture` characterization for selector
  precision weakening/improvement and finding identity loss between refactor
  sides (#1732, merge `1f67fd64`).
...
| `cargo test -p allow-diff structural_identity_posture` | pass | D7 diff posture characterization |
