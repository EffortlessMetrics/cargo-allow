...
if [[ "${SKIP_PACKAGE:-0}" != "1" ]]; then
  ...
  cargo package --workspace --locked --exclude cargo-intent --exclude proof-provider-api --exclude proof-adapter-command --exclude proof-adapter-cargo-allow --exclude proof-engine --exclude cargo-proof
